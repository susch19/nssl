...
class NSSLStrings {
  ...
  String addProductWithoutSearch() =>
      Intl.message('Insert the name of the product, without searching in the database', name: 'addProductWithoutSearch', locale: _localeName);
  ...
  String fixErrorsBeforeSubmittingPrompt() =>
      Intl.message('Please fix the errors in red before submitting.', name: 'fixErrorsBeforeSubmittingPrompt', locale: _localeName);
  ...
  String tokenExpiredExplanation() => Intl.message('Your token has expired. Login is required. If this happends multiple times per month, please contact us.',
      name: 'tokenExpiredExplanation', locale: _localeName);
