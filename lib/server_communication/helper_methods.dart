...
class HelperMethods {
  ...
  // static const int port = 4344;
  // static const String url = "http://192.168.49.22:4344";
  static final String deviceToken = Uuid().v7();
  ...
  static Future<http.Response> post(
    ...
    var res = await http.post(
      Uri(
        ...
        path: path,
        port: port,
        queryParameters: query /*, port: 4344*/,
      ),
  ...
  static Future<http.Response> put(
    ...
    var res = await http.put(
      Uri(host: host, scheme: scheme, path: path, port: port /*, port: 4344*/),
      body: jsonEncode(body),
      headers: _getHeaders(),
    );
    reactToRespone(res, context);
  ...
  static Map<String, String> _getHeaders() {
    return {
      ...
      User.token == "" ? "X-foo" : "X-Token": User.token,
    };
  }

  static bool reactToRespone(
